...
- Provider-specific OAuth refresh, live account enumeration/export adapters, catalog-to-profile authoring UX, and additional connector-native renderers remain future work and must preserve the private profile, exact approval, and sanitized outbox/status boundaries.
